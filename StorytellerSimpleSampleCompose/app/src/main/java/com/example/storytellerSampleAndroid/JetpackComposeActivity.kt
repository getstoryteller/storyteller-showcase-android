...
import com.example.storytellerSampleAndroid.compose.SampleStorytellerDelegate
import com.example.storytellerSampleAndroid.compose.SampleStorytellerDelegateImpl
...
class JetpackComposeActivity : ComponentActivity(), StorytellerListViewDelegate {
  ...
  private val viewModel: JetpackComposeViewModel by viewModels {
    ...
    JetpackComposeViewModelFactory(sampleStorytellerDelegate)
  }
