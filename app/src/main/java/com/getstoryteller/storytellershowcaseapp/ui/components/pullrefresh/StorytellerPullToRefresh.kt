...
internal class StorytellerPullToRefreshStateImpl(
  ...
  override val isRefreshing get() = _isRefreshing
  ...
  private val adjustedDistancePulled: Float get() = distancePulled * DRAG_MULTIPLIER
  private var _verticalOffset by mutableFloatStateOf(0f)
  private var _isRefreshing by mutableStateOf(initialRefreshing)
}
