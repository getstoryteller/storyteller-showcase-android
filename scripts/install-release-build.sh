...
adb shell am start -n "com.getstoryteller.storytellershowcaseapp/com.getstoryteller.storytellershowcaseapp.features.main.MainActivity" -a android.intent.action.MAIN -c android.intent.category.LAUNCHER
